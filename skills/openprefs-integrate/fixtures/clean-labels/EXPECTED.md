...
| `profileVisibility` | Who can view the user's profile. | `settingsControls` -> `setProfileVisibility` -> store state | `sensitive: true` only; this is a reversible visibility preference. |
